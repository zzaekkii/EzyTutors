...
-> Result<HttpResponse, Error> {
    let tutors: Vec<Tutor> = vec![
        Tutor {name: String::from("Tutor 1")},
        Tutor {name: String::from("Tutor 2")},
        Tutor {name: String::from("Tutor 3")},
        Tutor {name: String::from("Tutor 4")},
        Tutor {name: String::from("Tutor 5")},
    ];
